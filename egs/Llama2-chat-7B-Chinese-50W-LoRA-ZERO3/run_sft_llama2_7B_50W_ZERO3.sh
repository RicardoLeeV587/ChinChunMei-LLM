...
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes 1 --nproc_per_node 8 --master_port=25001 run_clm_sft_with_peft.py \
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes 1 --nproc_per_node 8 --master_port=25001 ./script/training/run_clm_sft_with_peft_zero3.py \
